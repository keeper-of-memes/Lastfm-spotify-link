...
LASTFM_USERNAME = 'LASTFM USERNAME'  # Replace with your Last.fm username
...
if __name__ == "__main__":
    ...
    if access_token:
        lastfm_track = read_lastfm_track(LASTFM_API_KEY, LASTFM_USERNAME)
        ...
        if lastfm_track:
            ...
            if track_name and artist_name:
                ...
                print("Track information incomplete.")
        else:
            print("No recent Last.fm track found.")
    else:
